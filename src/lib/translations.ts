  ...
  en: {
    ...
    hero: {
      ...
      description: {
        ...
        mid: "with Java & Spring. Focused on microservices, clean architecture, observability, and rigorous engineering — from",
        highlight2: "fintech",
        to: "to",
        highlight3: "mobility",
        end: ".",
  ...
  es: {
    ...
    hero: {
      ...
      description: {
        ...
        mid: "con Java y Spring. Especializado en microservicios, arquitectura limpia, observabilidad e ingeniería rigurosa — desde",
        highlight2: "fintech",
        to: "hasta",
        highlight3: "movilidad",
        end: ".",
      },
      cta1: "Ver proyectos",
      cta2: "Portfolio ↗",
